...
import chat.tox.viker.activities.LoginActivity
import chat.tox.viker.av.CallManager
import chat.tox.viker.tox.{ToxDataFile, ToxService, ToxSingleton}
import chat.tox.viker.toxme.{ToxData, ToxMe}
import chat.tox.viker.transfer.FileTransferManager
import chat.tox.viker.utils.AntoxNotificationManager
import chat.tox.viker.wrapper.ContactKey
