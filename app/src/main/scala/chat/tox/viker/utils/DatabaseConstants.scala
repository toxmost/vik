...
object DatabaseConstants {
  ...
  /**
    * Table used by [[chat.tox.viker.data.UserDB]] to store profile information.
  ...
  /**
    * [[chat.tox.viker.wrapper.ToxKey]] indicating the sender of a message. Will always correspond to a key in [[TABLE_CONTACTS]].
    */
  ...
  /**
    * Status message in [[chat.tox.viker.data.AntoxDB]]
    */
  val COLUMN_NAME_NOTE = "note"

  /**
    * Status message in [[chat.tox.viker.data.UserDB]].
    */
  ...
  /**
    * File kind of a message. [[chat.tox.viker.wrapper.FileKind.INVALID]] if the message is not a file.
    */
