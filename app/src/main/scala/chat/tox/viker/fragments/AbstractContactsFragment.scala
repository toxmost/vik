...
import chat.tox.viker.activities.{ChatActivity, FriendProfileActivity, GroupChatActivity}
import chat.tox.viker.adapters.ContactListAdapter
import chat.tox.viker.av.Call
import chat.tox.viker.data.{CallEventKind, State}
