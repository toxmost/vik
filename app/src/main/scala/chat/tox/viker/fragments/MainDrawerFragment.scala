...
import chat.tox.viker.activities.{AboutActivity, ProfileSettingsActivity, SettingsActivity}
import chat.tox.viker.callbacks.AntoxOnSelfConnectionStatusCallback
import chat.tox.viker.data.State
import chat.tox.viker.theme.ThemeManager
import chat.tox.viker.utils.{BitmapManager, IconColor}
import chat.tox.viker.wrapper.FileKind.AVATAR
import chat.tox.viker.wrapper.{UserInfo, UserStatus}
