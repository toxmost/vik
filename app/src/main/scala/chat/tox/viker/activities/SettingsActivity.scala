...
import chat.tox.viker.activities.SettingsActivity._
import chat.tox.viker.data.State
import chat.tox.viker.fragments.ColorPickerDialog
import chat.tox.viker.theme.ThemeManager
import chat.tox.viker.tox.{ToxService, ToxSingleton}
import chat.tox.viker.utils.{Hex, AntoxLog, AntoxNotificationManager, Options}
