...
import chat.tox.viker.Utils2
import chat.tox.viker.data.State
import chat.tox.viker.tox.{IntervalLevels, Intervals, ToxSingleton}
import chat.tox.viker.utils.{AntoxLog, BitmapManager, Constants}
import chat.tox.viker.wrapper.FileKind.AVATAR
import chat.tox.viker.wrapper.{ContactKey, FileKind, FriendKey}
...
class FileTransferManager extends Intervals {
  ...
  /**
    ...
    * (i.e. in [[chat.tox.viker.callbacks.AntoxOnFileRecvCallback]]
