package chat.tox.viker.adapters
...
import chat.tox.viker.adapters.ContactListAdapter._
import chat.tox.viker.data.State
import chat.tox.viker.fragments.ContactItemType
import chat.tox.viker.tox.ToxSingleton
import chat.tox.viker.utils.{IconColor, _}
import chat.tox.viker.wrapper.{ContactKey, FriendKey, GroupKey}
